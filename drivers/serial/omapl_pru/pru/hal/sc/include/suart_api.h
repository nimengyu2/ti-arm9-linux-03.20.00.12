...
/** DIR */
#define PRU_SUART_DIR_DISABLED          (0u)
#define PRU_SUART_DIR                 (1u)

#define PRU_SUART_R30_16                (16u)
#define PRU_SUART_R30_17                (17u)
#define PRU_SUART_R30_18                (18u)
#define PRU_SUART_R30_19                (19u)
#define PRU_SUART_R30_20                (20u)
#define PRU_SUART_R30_21                (21u)
#define PRU_SUART_R30_22                (22u)
#define PRU_SUART_R30_23                (23u)
#define PRU_SUART_R30_24                (24u)
#define PRU_SUART_R30_25                (25u)
#define PRU_SUART_R30_26                (26u)
#define PRU_SUART_R30_27                (27u)
#define PRU_SUART_R30_28                (28u)
#define PRU_SUART_R30_29                (29u)
#define PRU_SUART_R30_30                (30u)
#define PRU_SUART_R30_31                (31u)
#define PRU_SUART_R30_NONE		(32u)

/** Timer2 Registers */
#define TIMER2BASE                     (0x01F0C000)
#define TIM12                          (0x10)
#define PRD12                          (0x18)
#define TCR                            (0x20)
#define TGCR                           (0x24)
...
/** Syscfg Registers */
#define SYSCFGBASE                     (0x01C14000u)
#define KICK0R_OFFSET                  (0x00000038)
#define KICK1R_OFFSET                  (0x0000003C)
#define CFGCHIP3_OFFSET                (0x00000188)
...
typedef struct {
    ...
    unsigned char DIREnable;	/**< DIR Enabled */
    unsigned char DIRDelay;	/**< DIR Delay */
    unsigned char DIRPin;	/**< DIR GPO Pin Mapping */
} suart_config;
 ...
 */
	...
	short pru_softuart_setdir
	    (suart_handle hUart, unsigned short dir_delay_offset,
	     unsigned int timer_freq, unsigned short txClkDivisor);

	short pru_softuart_setparity
            (suart_handle hUart, unsigned short tx_parity,
	     unsigned short rx_parity);
