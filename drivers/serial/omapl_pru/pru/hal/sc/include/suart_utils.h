...
#define MCASP_PDIR_VAL ( \
	...
	extern void suart_timer2_config(void);
	extern void suart_mcasp_psc_disable(unsigned int psc1_addr);
	extern void suart_mcasp_psc_enable(unsigned int psc1_addr);
        extern void scrdr_ehrpwm_psc_disable(unsigned int psc1_addr);
        extern void scrdr_ehrpwm_psc_enable(unsigned int psc1_addr);
