...
static struct clk timerp64_2_pru_clk = {
        .name           = "timer2_pru",
        .parent         = &pll0_sysclk2,
        .flags          = DA850_CLK_ASYNC3,
};
...
static struct clk_lookup da850_clks[] = {
	...
	CLK(NULL,               "timer2_pru",   &timerp64_2_pru_clk),
...
// nmy modify
	...
	//MUX_CFG(DA850, GPIO1_4,		4,	12,	15,	2,	false)
	//MUX_CFG(DA850, GPIO1_5,		4,	8,	15,	2,	false)
...
const short da850_nand_pins[] __initdata = {
	...
	DA850_EMA_A_0, DA850_EMA_A_1, DA850_EMA_A_2, 
	DA850_NEMA_CS_2,DA850_NEMA_CS_3, DA850_NEMA_CS_4,
